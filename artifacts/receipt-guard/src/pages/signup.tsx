      ...
      <Card className="w-full max-w-md border-border/50 bg-card/80 backdrop-blur-xl shadow-2xl">
        <CardHeader className="space-y-3 pb-6">
          ...
          <CardDescription className="text-base">
            Start organizing your financial life in minutes.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <Button variant="outline" className="w-full h-12 rounded-lg font-medium border-border hover:bg-secondary" onClick={handleGoogleSignup}>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input type="text" required placeholder="John Doe" className="h-11 rounded-lg bg-background" />
              </div>
              <div className="space-y-2">
        ...
        <CardFooter className="justify-center border-t border-border/50 pt-6">
          <p className="text-sm text-muted-foreground">
            Already have an account? <span className="text-primary cursor-pointer hover:underline font-medium" onClick={() => setLocation("/login")}>Sign in</span>
          </p>
        </CardFooter>
      </Card>
    </div>
